...
public class FirebaseDatabaseWriter implements DatabaseWriter {
    ...
    public void writeUser(final User newUser, final User oldUser, final String uid, final Collection<UserHome> userHomes, final DatabaseWriterListener listener) {
        ...
        if (newUser.getImage() != null) {
            ...
            if (oldUser != null && oldUser.getImageStoragePath() != null) {
    ...
    @Override
    public void writeHome(Home home, DatabaseWriterListener listener) {
        String homePath = DatabaseConstants.HOMES + DatabaseConstants.SEPARATOR + home.getName();
