        ...
        floatNext.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (checkInput()) {
                    ...
                    auth.signIn(inputEmail.getText().toString(), inputPassword.getText().toString(), new AuthListener() {
                        @Override
                        public void onSuccess() {
                            databaseReader.retrieveUser(auth.getCurrentUserUid(), new DatabaseReaderListener() {
                                @Override
